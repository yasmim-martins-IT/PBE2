...
class JogoCartas():
    ...
    def embaralhar_cartas(self) :
        self.cartas_embaralhadas = random.shuffle(self.cartas)

        self.cartas = self.cartas_embaralhadas
    ...
    def distribuir_cartas(self,quantidade_jogadores):
        try:
            ...
            return 'Erro ao distribuir cartas'
    ...
    def jogar_carta (self,jogador,carta_jogada):
        ...
        if carta_jogada not in self.jogadores[jogador]['carta']:
            return 'Essa cartão não esta no seu baralho'
